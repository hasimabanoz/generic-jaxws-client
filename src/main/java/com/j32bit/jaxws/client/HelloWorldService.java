 ...
 *
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://jaxws.j32bit.com.tr/", wsdlLocation = "http://localhost:8080/generic-service/services/hello?wsdl")
public class HelloWorldService extends Service {
	...
	private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://jaxws.j32bit.com.tr/", "HelloWorldService");

	static {
		URL url = null;
		WebServiceException e = null;
		try {
			url = new URL("http://localhost:8080/generic-service/services/hello?wsdl");
	...
	public HelloWorld getHelloWorldPort() {
		return super.getPort(new QName("http://jaxws.j32bit.com.tr/", "HelloWorldPort"), HelloWorld.class);
	}
	...
	public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://jaxws.j32bit.com.tr/", "HelloWorldPort"), HelloWorld.class, features);
	}
